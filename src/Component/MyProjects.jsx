...
const MyProjects = () => {
  return (
    <>
        ...
        <div className="flex justify-center items-center border-4 border-gray-400 shadow-xl shadow-yellow-200 lg:w-[900px] w-11/12 bg-gray-900  mx-auto mt-5 mb-8">
          ...
          >
              ...
              <div className="flex flex-col">
                <div className="flex flex-col lg:w-1/3 lg:p-8 p-6">
                  ...
                  <p className="text-[20px] text-gray-300 mt-5">
                    ...
                    Express and Node.Js My Task was to program fully and testing
                    the Backend API and to model the database in MongoDB.
                  </p>
                ...
                <div className="flex lg:flex-row flex-col">
                  ...
                  <img
                    src={weather}
                    alt="projectImg"
                    className="absolute lg:left-[24rem] left-[11rem] md:left-[32rem] lg:w-[400px] w-[120px] lg:h-[400px] h-[150px] lg:top-12"
                  />
                </div>
              </div>
            </SwiperSlide>
            <SwiperSlide>
              <div className="flex flex-col">
                <div className="flex flex-col lg:w-1/3 lg:p-8 p-6">
                  <h1 className="text-3xl text-white"> APP</h1>
                  <p className="text-[20px] text-gray-300 mt-5">
                    A MERN app that we built as Project using React, MongoDB,
                    Express and Node.Js My Task was to program fully and testing
                    the Backend API and to model the database in MongoDB.
                ...
                <div className="flex lg:flex-row flex-col">
                  ...
                  <img
                    src={weather}
                    alt="projectImg"
                    className="absolute lg:left-[24rem] left-[13rem] md:left-[32rem] lg:w-[400px] w-[160px] lg:h-[400px] h-[150px] lg:top-12"
                  />
                </div>
              </div>
            </SwiperSlide>
            ...
            <SwiperSlide>
              <div className="flex flex-col">
                <div className="flex flex-col lg:w-1/3 lg:p-8 p-6">
                  <h1 className="text-3xl text-white">Website clone</h1>
                  <p className="text-[20px] text-gray-300 mt-5">
                    A website that we built as Project using HTML, CSS,
                    Javascript.
                  </p>
                  <p className="text-2xl">Technologies</p>
                </div>
                ...
                <div className="flex lg:flex-row flex-col">
                  ...
                  <img
                    ...
                    loading="lazy"
                    alt="projectImg"
                    className="absolute bg-cover lg:left-[24rem] left-[13rem] md:left-[32rem] lg:w-[400px] w-[160px] lg:h-[400px] h-[150px] lg:top-12"
                  />
                </div>
              </div>
            </SwiperSlide>
            <SwiperSlide>
              <div className="flex flex-col">
                <div className="flex flex-col lg:w-1/3 lg:p-8 p-6">
                  <h1 className="text-3xl text-white">StudyNotion APP</h1>
                  <p className="text-[20px] text-gray-300 mt-5">
                    A MERN app that we built as Project using React, MongoDB,
                    Express and Node.Js My Task was to program fully and testing
                    the Backend API and to model the database in MongoDB.
                ...
                <a
                  className="text-black text-center bg-orange-400 p-2 text-3xl"
                  href="https://studynotion-frontends.vercel.app"
                >
                  Live Demo
                </a>
              </div>
      ...
      <div className="flex items-center text-2xl justify-center space-x-6  mb-8">
        <a
          className=" p-2 px-8  bg-orange-500 rounded-md  hover:-translate-y-2 duration-200 transition-all"
          href="https://studynotion-frontends.vercel.app/"
        >
          Live DEMO
        </a>
